# PurramidTime - Clock - App-Intent Development Specifications
Purramid Time is a classroom management tool that displays three time-keeping app-intents. The clock provides analog and digital views for time across the globe.
