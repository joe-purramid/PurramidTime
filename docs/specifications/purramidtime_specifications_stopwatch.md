			...
			(8.2.2.5) "Add Another"
				...
				(8.2.2.5.2) When a user touches the Add Another button
					...
					(8.2.2.5.2.2) a new stopwatch appears at the geometric center of the screen.
						(8.2.2.5.2.2.1) the new stopwatch is offset 25px to the right and 25px down if a stopwatch already exists at the center of the screen.
						(8.2.2.5.2.2.2) it adopts all the preferences of the stopwatch from which it was opened
							(8.2.2.5.2.2.2.1) For example, a new stopwatch opened from a 300px by 300px stopwatch that has a light blue background would also be a 300px by 300px stopwatch with a light blue background.
...
### (11) RESET
	(11.1) When a user taps the reset button
		...
		(11.1.2) the timer resets to 00:00:00.00
			(11.1.2.1) If there were lap times displayed, all lap times are cleared
		(11.1.3) if time was paused
			(11.1.3.1) time remains paused
		(11.1.4) if time was running
			(11.1.4.1) time begins counting from 0.
